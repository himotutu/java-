...
public class BaseDeviceServiceImpl  implements IBaseDeviceService {
    ...
    @Override
    public List<BaseDevice> findDljByCompid(Integer compid) {
        return dao.findDljByCompid(compid);
    }

    @Override
    public List<BaseDevice> findCzjByCompid(Integer compid) {
        return dao.findCzjByCompid(compid);
    }

    @Override
    public List<BaseDevice> findPdjByCompid(Integer compid) {
